...
/**
 * Clase que representa los textos de una traduccion usado para almacenar en XML
 *
 * @author César
 */
public final class Textos {

    private String assets;   //Nombre del Assets
    private String fichero;  //Nombre del fichero
    private byte[] id;       //Identificador del bloque
    private String idioma;   //Nombre del idioma
    private String[] lineas; //Lineas dentro de la traducción
